...
本地解法来源：`java/{题号}.java`。表格分两部分：前 100 行为 Codetop 公司题频 Top 100（按题频降序，其中 98 道可匹配本地 Java 题解，2 道未收录：补充题2、补充题23）；其后为本地已解但不在 Top 100 的 LeetCode Hot 100 题目（按题号升序，共 41 道）。合计 141 行，其中 139 道有本地题解。
